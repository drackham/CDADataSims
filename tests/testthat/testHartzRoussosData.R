...
test_that("y has correct proportions of correct responses", {
  expect_equal(mean(data$y[,1]),  expected = .34, tolerance = 0.1, scale=1)
  expect_equal(mean(data$y[,2]),  expected = .22, tolerance = 0.1, scale=1)
  expect_equal(mean(data$y[,3]),  expected = .24, tolerance = 0.1, scale=1)
  expect_equal(mean(data$y[,4]),  expected = .54, tolerance = 0.1, scale=1)
  expect_equal(mean(data$y[,5]),  expected = .27, tolerance = 0.1, scale=1)
  expect_equal(mean(data$y[,6]),  expected = .39, tolerance = 0.1, scale=1)
  expect_equal(mean(data$y[,7]),  expected = .31, tolerance = 0.1, scale=1)
  expect_equal(mean(data$y[,8]),  expected = .28, tolerance = 0.1, scale=1)
  expect_equal(mean(data$y[,9]),  expected = .26, tolerance = 0.1, scale=1)
  expect_equal(mean(data$y[,10]), expected = .39, tolerance = 0.1, scale=1)

  expect_equal(mean(data$y[,11]), expected = .38, tolerance = 0.1, scale=1)
  expect_equal(mean(data$y[,12]), expected = .49, tolerance = 0.1, scale=1)
  expect_equal(mean(data$y[,13]), expected = .30, tolerance = 0.1, scale=1)
  expect_equal(mean(data$y[,14]), expected = .44, tolerance = 0.1, scale=1)
  expect_equal(mean(data$y[,15]), expected = .22, tolerance = 0.1, scale=1)
  expect_equal(mean(data$y[,16]), expected = .36, tolerance = 0.1, scale=1)
  expect_equal(mean(data$y[,17]), expected = .39, tolerance = 0.1, scale=1)
  expect_equal(mean(data$y[,18]), expected = .17, tolerance = 0.1, scale=1)
  expect_equal(mean(data$y[,19]), expected = .29, tolerance = 0.1, scale=1)
  expect_equal(mean(data$y[,20]), expected = .39, tolerance = 0.1, scale=1)

  expect_equal(mean(data$y[,21]), expected = .44, tolerance = 0.1, scale=1)
  expect_equal(mean(data$y[,22]), expected = .37, tolerance = 0.1, scale=1)
  expect_equal(mean(data$y[,23]), expected = .35, tolerance = 0.1, scale=1)
  expect_equal(mean(data$y[,24]), expected = .39, tolerance = 0.1, scale=1)
  expect_equal(mean(data$y[,25]), expected = .28, tolerance = 0.1, scale=1)
  expect_equal(mean(data$y[,26]), expected = .54, tolerance = 0.1, scale=1)
  expect_equal(mean(data$y[,27]), expected = .56, tolerance = 0.1, scale=1)
  expect_equal(mean(data$y[,28]), expected = .29, tolerance = 0.1, scale=1)
  expect_equal(mean(data$y[,29]), expected = .24, tolerance = 0.1, scale=1)
  expect_equal(mean(data$y[,30]), expected = .43, tolerance = 0.1, scale=1)

  expect_equal(mean(data$y[,31]), expected = .21, tolerance = 0.1, scale=1)
  expect_equal(mean(data$y[,32]), expected = .33, tolerance = 0.1, scale=1)
  expect_equal(mean(data$y[,33]), expected = .39, tolerance = 0.1, scale=1)
  expect_equal(mean(data$y[,34]), expected = .24, tolerance = 0.1, scale=1)
  expect_equal(mean(data$y[,35]), expected = .21, tolerance = 0.1, scale=1)
  expect_equal(mean(data$y[,36]), expected = .40, tolerance = 0.1, scale=1)
  expect_equal(mean(data$y[,37]), expected = .32, tolerance = 0.1, scale=1)
  expect_equal(mean(data$y[,38]), expected = .32, tolerance = 0.1, scale=1)
  expect_equal(mean(data$y[,39]), expected = .20, tolerance = 0.1, scale=1)
  expect_equal(mean(data$y[,40]), expected = .45, tolerance = 0.1, scale=1)
})
